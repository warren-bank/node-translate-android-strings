...
call :translate-android-strings -i "en" -o "de" -o "es" -o "fr" -o "zh" -o "zh-TW" -f "%input_file%" -d "%output_dir%" -m -b "Adam Adamant" -b "Blankety Blank" -b "Chucky Cheese" --nc --nw --debug >"%log_file%" 2>&1
